...
const MapScreen = () => {
    ...
    return (
        <SafeAreaView className=' flex-1 bg-white'>
            <View className=' flex-row items-center justify-center px-4 py-3 borber-b border-gray-100'>
                <TouchableOpacity
                    onPress={() => router.back()}
                    className=' h-9 w-9 flex-row justify-center items-center rounded-full bg-gray-100'>
