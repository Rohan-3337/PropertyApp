import { useSavedProperty } from '@/hooks/useSaveProperty';
...
const PropertyDetails = () => {
    ...
    const ADMIN_PHONE = "+919560127874";
    ...
    // ✅ Safe to compute here — property is guaranteed non-null
    ...
    return (
        <View className="flex-1 bg-white">
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {/* Top Navigation Bar */}
                <SafeAreaView className="absolute right-0 left-0 top-0">
                ...
                >
                    ...
                    <View className="flex-row justify-between bg-gray-50 rounded-2xl p-4 mb-5">
                        ...
                        <SpecItem icon="expand-outline" label="Area" value={`${property.area_sqft} ft²`} />
                    ...
                    {/* ✅ Fixed: "Location" not "Description" */}
                    ...
                    {/* ✅ Fixed: isAdmin (not !isAdmin) — only admins see these */}
                    {!isAdmin && (
