...
const FilterModal = ({ visible, onClose }: FilterModal) => {
    const { search, setSearch, bedrooms, setBedrooms, type, minPrice, maxPrice, setMaxPrice, setMinPrice, setType, resetFilters } = useFilterStore();
